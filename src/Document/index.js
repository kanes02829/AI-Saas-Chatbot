    ...
    <div style={{ width: '100%' }}>
      ...
      {showModal ? (
        <>
          <div
            id="document"
            className="items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50"
            style={{
          ...
          >
            <div className="relative w-auto my-6 mx-auto max-w-6xl">
              {/*content*/}
              <div
                className="border-3 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none"
                style={{
                  borderWidth: '3px',
                  borderColor: 'rgba(116,16,162,0.5)',
                  borderStyle: 'solid',
                }}
              >
                {/*header*/}
