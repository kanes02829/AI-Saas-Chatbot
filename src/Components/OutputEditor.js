  ...
  return (
    <div>
      <div className="m_input_widget flex items-center">
        ...
        <Tooltip title="Export TXT" arrow>
          <div
            className="mx-1"
            style={{
              display: 'inline-block',
        ...
        <Tooltip title="Copy Clipboard" arrow>
          <div
            className="mx-1"
            style={{
              display: 'inline-block',
      ...
      {msgVisible && (
        <div
          className="bg-white px-5 py-3.5 rounded-lg shadow max-w-sm mx-auto transform transition duration-100 ease-linear"
          style={{
            textAlign: 'center',
            border: '1px solid rgb(116,16,162,1)',
            color: 'rgba(116,16,162,1)',
            position: 'fixed',
            top: '10px',
            right: '20px',
